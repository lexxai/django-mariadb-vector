...
class MariaVectorField(models.Field):
    """
    ...
    description = "Vector filed for MariaDB 11.8+"
...
def check_mariadb_version(min_version=MARIADB_MIN_VERSION):
    ...
    if version_tuple < min_version_tuple:
        ...
        raise ValueError(f"MariaDB version {version_str} is below required version {min_version} for VECTOR support")
